...
public class DiffieHellman {
    ...
    public DiffieHellman() {
        try {
            ...
            prop.load(new FileInputStream("/Users/duarteduarte/Programming/MEI/SDC-SSI/x_PlayingWithSecurity/bananaStarter_wout/src/config.properties"));
    ...
    public KeyPair generateKeyPair(boolean great) {
        KeyPair aPair = null;
        if (!great) {
