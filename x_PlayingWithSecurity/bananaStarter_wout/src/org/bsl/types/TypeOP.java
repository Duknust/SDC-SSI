...
public enum TypeOP implements Serializable {
    ...
    NULL, REQ_RETRY, REQ_REGISTER, REP_REGISTER, REQ_PROJ, REP_PROJ, REQ_MAP_PROJ, REP_MAP_PROJ, REP_NAME_PROJ, REQ_NAME_PROJ, ADD_PROJECT, ACT_PROJECT, REQ_LOGIN, REP_LOGIN, REQ_ADD_EUROS, REP_ADD_EUROS, UNLOCK, LOCK, NOTIFEUROS
